...
class Bottleneck_MCPC(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
...
class C3k_MCPC(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(Bottleneck_MCPC(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))

class MCPC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_MCPC(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_MCPC(self.c, self.c, shortcut, g) for _ in range(n))
